...
| **Gambit** (M5 playbook: Judas + Reprise) | spec `2026-08-02-gambit-m5-playbook-design.md` | **Kill-screen 2026-08-03: Judas INSUFFICIENT-N (n=69), Reprise FAIL** — both NO-GO, one-pass; code merged inert (`status: research`, all setups disabled) | Reprise: +0.036R mean, CI [−0.046, +0.119] straddles 0, 4/4 syms +, median cost 0.078R (habitat fixed the M5 cost problem); Judas: 69 fills vs 150 floor (`2026-08-03-gambit-killscreen-results.md`) | Chassis + flat_at_ny + harness stay as infrastructure; a future setup (e.g. ORB post-Bell) enters as a new detector class with its own gate |
