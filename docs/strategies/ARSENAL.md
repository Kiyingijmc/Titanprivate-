...
| **Gyroscope** | [gyroscope.md](gyroscope.md) | research **NO-GO** (2026-07-15) | pooled −0.067R, 4/9 symbols, false-entry 27.1% vs α=5% | None (D6: revisit only after SB has a live number). KalmanDrift retained as infra |
...
ICT_OTE canonical (−0.158R, NO-GO everywhere), Unicorn, CRT (removed 2026-07-12), MTF-PB v1/v2
(−0.274R pooled), Donchian-20 D1 (wrong horizon). The graveyard is the calibration set: base rate
