---
name: design-eng
description: Design-engineering reference for titan-ict-bot — animation decisions, easing, springs, component polish, performance, accessibility. Used by the mig-frontend-* agents.
---

# Design Engineering

> Adapted from Emil Kowalski’s design-engineering philosophy ([animations.dev](https://animations.dev/)).
