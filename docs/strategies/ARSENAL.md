...
| **Gyroscope** | [gyroscope.md](gyroscope.md) | v1 research **NO-GO** (2026-07-15); **v2 innovation-SPRT NO-GO-as-registered (2026-08-01), 6/7 criteria pass — owner disposition pending** | v1: pooled −0.067R, false-entry 27.1% vs α=5%. v2 (trend universe, managed exits): **+0.057R net, OOS +0.033R, bootstrap LB +0.003R, PF 1.13**; failed only a mis-specified flip-rate sub-metric | Owner call per `2026-08-01-gyroscope2-gate-results.md`: accept NO-GO, or ratify a corrected calibration metric in a fresh pre-registered gate (params frozen) |
| **MaSlopeBaseline** | covered in [gyroscope.md](gyroscope.md) | research forever (control) | never gated (moot) | Remains the mandatory trend-baseline comparator |
